...
import (
	...
	versioned "github.com/gy-ulbak96/go_cloud_controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/gy-ulbak96/go_cloud_controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/gy-ulbak96/go_cloud_controller/pkg/generated/listers/cloudcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudcontrollerV1alpha1().Servers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudcontrollerV1alpha1().Servers(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudcontrollerv1alpha1.Server{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serverInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudcontrollerv1alpha1.Server{}, f.defaultInformer)
}
