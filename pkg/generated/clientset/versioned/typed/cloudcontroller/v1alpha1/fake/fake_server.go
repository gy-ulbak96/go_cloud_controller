...
type FakeServers struct {
	Fake *FakeCloudcontrollerV1alpha1
	ns   string
}

var serversResource = schema.GroupVersionResource{Group: "cloudcontroller.k8s.io", Version: "v1alpha1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "cloudcontroller.k8s.io", Version: "v1alpha1", Kind: "Server"}
