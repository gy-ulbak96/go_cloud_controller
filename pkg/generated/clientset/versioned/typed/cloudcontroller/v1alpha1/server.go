...
import (
	...
	scheme "github.com/gy-ulbak96/go_cloud_controller/pkg/generated/clientset/versioned/scheme"
...
func newServers(c *CloudcontrollerV1alpha1Client, namespace string) *servers {
	return &servers{
		client: c.RESTClient(),
		ns:     namespace,
	}
